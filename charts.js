class FinanceCharts {
    ...
    updateCharts(transactions) {
        if (!transactions || transactions.length === 0) {
            // Limpiar las gráficas si no hay datos
            this.clearCharts();
            return;
        }
        ...
        // Actualizar gráfica de balance con fechas formateadas
        ...
        this.balanceChart.data.labels = dates.map(date => formatearFecha(date));
